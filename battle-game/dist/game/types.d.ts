...
export type GamePhase = 'intro' | 'playing' | 'resolving-player-attack' | 'resolving-enemy-attack' | 'wave-transition' | 'paused' | 'victory' | 'defeat' | 'destroyed';
...
export type GameAction = {
    ...
    type: 'PLAYER_ATTACK_FINISHED';
    now: number;
} | {
    type: 'ENEMY_ATTACK_FINISHED';
    now: number;
} | {
    type: 'WAVE_TRANSITION_FINISHED';
    now: number;
} | {
    type: 'PAUSE';
    reason: PauseReason;
} | {
    type: 'CLEAR_PAUSE_REASON';
    reason: PauseReason;
} | {
    type: 'RESUME';
    now: number;
...
export type GameEffect = {
    ...
    type: 'ANIMATE_ENEMY_ATTACK';
    enemyId: string;
    advance: boolean;
} | {
    type: 'ANIMATE_ENEMY_DEATH';
    enemyId: string;
} | {
    type: 'ANNOUNCE';
    message: string;
    ...
    type: 'FOCUS';
    target: 'first-answer' | 'resume' | 'play-again';
};
